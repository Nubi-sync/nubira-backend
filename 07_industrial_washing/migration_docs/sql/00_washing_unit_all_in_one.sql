...
-- 6. Washing Workers & Task Allocations Matrix
...
CREATE POLICY "Allow public read washing workers" ON public.washing_workers FOR SELECT USING (true);
CREATE POLICY "Allow public insert/update washing workers" ON public.washing_workers FOR ALL USING (true);
...
CREATE POLICY "Allow public read washing tasks" ON public.washing_task_allocations FOR SELECT USING (true);
CREATE POLICY "Allow public insert/update washing tasks" ON public.washing_task_allocations FOR ALL USING (true);
